...
Select "Community AMIs" and search for EDAMAME-2015 and Click the blue "Select" button on the right.
...
At this point Amazon will prompt you to generate or use an existing key pair. For the purposes of this course we are doing things slightly differently. Some issues with our AMI require us to use a specific keypair. Download the keypair [here](https://raw.githubusercontent.com/edamame-course/docs/gh-pages/eda.pem). 
