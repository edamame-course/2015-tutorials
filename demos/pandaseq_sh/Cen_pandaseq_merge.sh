...
do
    pandaseq -f ${file}F.fastq -r ${file}R.fastq -w ext_pandaseq_merged_reads/${file}_merged.fastq -g ext_pandaseq_merged_reads/${file}_merged.log -B -F -A simple_bayesian -l 253 -L 253 -o 47 -O 47 -t 0.9
